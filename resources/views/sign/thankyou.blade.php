...
<div style="width:850px;" class="mx-auto bg-gray-100 rounded">
    <h2 class="text-center text-2xl font-semibold text-black py-2 pt-4">Thank You For Proceeding!</h2>
    <p class="text-center text-base text-blank py-2">Your account manager will be in touch shortly with the next steps to progress your project.</p>
    <p class="text-center text-sm text-blank py-2 pb-4">You can close this browser down safely now.</p>
</div>
